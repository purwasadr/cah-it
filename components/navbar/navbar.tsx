...
const Navbar = () => {
    ...
    const handleSearchQueryChange = async (
        ...
        let timeout = setTimeout(() => {
            PostModel.getPostSearch(e.target.value)
                        ...
                        <div className="flex justify-center items-center min-h-screen px-4">
                            <div className="w-full max-w-lg overflow-hidden transition-all transform bg-white shadow-xl rounded-2xl">
                                <Combobox
                                    ...
                                    onChange={() => setIsOpenDialog(false)}
                                >
                                    <div className="flex items-center gap-2 px-4 border-b-[1px]">
                                        <SearchIcon className="h-4 w-4 text-slate-500" />
                                        <Combobox.Input
                                            className="w-full h-12 border-0  py-2 pl-3 pr-10 text-sm text-gray-900 focus:ring-0"
                                        ...
                                        <Combobox.Options>
                                            {searchResult.map((post) => (
                                                ...
                                                >
                                                    <a>
                                                        <Combobox.Option
                                                            className="py-3 px-4 font-medium hover:bg-slate-100"
                                                            value={post}
                                                        >
                                                            {post.title}
                                                        </Combobox.Option>
